...
_magic_number = 10
_modified_time = 1520107020.5778232
_enable_loop = True
    ...
    try:
        ...
        if photo_array:
            for image in photo_array:
                ...
                __M_locals.update(__M_dict_builtin([(__M_key, __M_locals_builtin_stored[__M_key]) for __M_key in ['thumb_link','link','title','extra_class'] if __M_key in __M_locals_builtin_stored]))
